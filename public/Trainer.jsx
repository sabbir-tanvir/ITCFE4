...
const Trainer = () => {
  ...
  if (loading || !buttonColor) {
    return (
      <section className="relative container mx-auto px-4 lg:py-12 lg:mt-20">
  ...
  return (
    <section className="relative container mx-auto px-4 lg:py-12 lg:mt-20">
          ...
          >
            ...
            <div className="p-4 text-center">
              ...
              <button
                ...
                className=" text-white py-2 px-4 rounded hover:bg-red-500  transition-colors duration-300"
      ...
      {visibleTrainers < trainers.length && (
        <div className="relative text-center mb-14 mt-12 z-10">
          <button
            ...
            className=" text-white py-2 px-6 rounded hover:bg-red-500 transition-colors duration-300 relative z-10"
            style={{ backgroundColor: buttonColor }}
          >
            আরও দেখুন
          </button>
      ...
      {isModalOpen && selectedTrainer && (
        ...
        >
          <div
            className="bg-white rounded-lg w-[95%] max-w-[1022px] max-h-[90vh] overflow-hidden shadow-2xl"
                ...
                <div className="w-full mx-auto">
                  <div className="self-stretch p-4 md:p-6 rounded-xl outline outline-1 outline-offset-[-1px] outline-CTAColor bg-white min-h-[200px] md:min-h-[350px]">
                    <div className="clearfix min-h-[160px] md:min-h-[310px]">
                      <img
                        className="float-left w-32 h-32 md:w-52 md:h-80 rounded-2xl object-cover mr-6 mb-4"
